...
if mouse.deltaX:
	if freelook:
		...
		x_mult = 1.0 - (0.9 * (x_ratio ** 3)) # Exponential falloff: 1.0x at center, dropping to 0.1x at max
...
if mouse.deltaY:
	if freelook:
		...
		y_mult = 1.0 - (0.9 * (y_ratio ** 3)) # Exponential falloff: 1.0x at center, dropping to 0.1x at max
